...
const FunnelOrdersPanel = dynamic(
  () =>
    import("@/app/components/campaign/FunnelOrdersPanel").then(
      (mod) => mod.FunnelOrdersPanel,
    ),
  {
    ssr: false,
    loading: () => (
      <div className="p-4" aria-busy="true" aria-label="Loading orders">
...
export default function CampaignOrdersPage() {
  ...
  const canAccess = isOwnerLike || can("campaigns_orders");
