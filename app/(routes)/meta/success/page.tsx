...
function MetaConnectSuccessInner() {
    ...
    <main className="flex min-h-dvh flex-col items-center justify-center bg-zinc-50 px-4 py-12">
      <div className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-8 text-center shadow-sm">
        ...
        <p className="mt-2 text-sm text-zinc-600">
          Your Meta account is linked. You can launch ads and use your funnel
          tracking link in Meta Ads Manager.
        </p>
        <Link
          href={campaignsHref}
...
export default function MetaConnectSuccessPage() {
  return (
    <Suspense
      fallback={
