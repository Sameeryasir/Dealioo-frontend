...
type GoogleAdsAppPromotionSetupProps = {
  onCancel: () => void;
  onContinue: () => void;
};
...
function ChannelIcons() {
  return (
    <div className="mb-3 flex flex-wrap items-center gap-1.5" aria-hidden>
      <span className="inline-flex size-6 items-center justify-center rounded-sm bg-white ring-1 ring-[#dadce0]">
      ...
      <span
        title="YouTube"
        className="inline-flex size-6 items-center justify-center rounded-sm bg-[#FF0000]"
      >
      ...
      <span className="inline-flex size-6 items-center justify-center rounded-sm bg-white ring-1 ring-[#dadce0]">
        <svg viewBox="0 0 24 24" className="size-3.5">
          <path fill="#EA4335" d="M2 6.5V18h4.5V11l5.5 4 5.5-4v7H22V6.5L12 13.5 2 6.5z" />
          <path fill="#C5221F" d="M2 6.5 12 13.5 22 6.5H2z" opacity=".35" />
        </svg>
      </span>
      <span className="inline-flex size-6 items-center justify-center rounded-sm bg-white ring-1 ring-[#dadce0]">
      ...
      <span className="inline-flex size-6 items-center justify-center rounded-sm bg-white ring-1 ring-[#dadce0]">
        <svg viewBox="0 0 24 24" className="size-3.5">
          ...
          <path fill="#34A853" d="M17.5 9 21 11.2c.7.4.7 1.2 0 1.6L17.5 15 14 12l3.5-3z" />
        </svg>
      </span>
    </div>
  );
...
const SUBTYPES: {
  ...
  },
  {
    ...
    description:
      "Get new users to pre-register for your app before launch",
  },
];

export function GoogleAdsAppPromotionSetup({
  onCancel,
  onContinue,
}: GoogleAdsAppPromotionSetupProps) {
  const [campaignName, setCampaignName] = useState("App promotion-App-1");
