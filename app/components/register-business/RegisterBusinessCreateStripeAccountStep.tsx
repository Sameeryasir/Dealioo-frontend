                ...
                <section className={styles.card}>
                  <header className={styles.header}>
                    ...
                    <p className={styles.subtitle}>
                      To get paid with Dealioo, you&apos;ll need a Stripe
                      account. We opened Stripe signup in a new tab — follow the
                      steps below, then come back here to connect.
                    </p>
                  </header>
